...
?>
	<form action="<?php echo JRoute::_('index.php?option=com_form2content&task=users.display&layout=modal&view=users&tmpl=component&groups='.JRequest::getVar('groups', '', 'default', 'BASE64').'&excluded='.JRequest::getVar('excluded', '', 'default', 'BASE64'));?>" method="post" name="adminForm" id="adminForm">
