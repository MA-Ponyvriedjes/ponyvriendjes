			...
			<fieldset id="filter-bar" class="f2c_search">	
				<div class="filter-search fltlft">
					<?php if($this->menuParms->get('show_search_filter')) : ?>
						...
						<input type="text" name="forms_filter_search" id="forms_filter_search" class="f2c_filter" value="<?php echo $this->escape($this->state->get('forms.filter.search')); ?>" title="<?php echo JText::_('COM_FORM2CONTENT_FILTER_SEARCH_DESC'); ?>" />
						<button type="submit" class="btn f2c_button f2c_submit"><?php echo JText::_('JSEARCH_FILTER_SUBMIT'); ?></button>
						<button type="button" class="btn f2c_button f2c_reset" onclick="document.id('forms_filter_search').value='';this.form.submit();"><?php echo JText::_('JSEARCH_FILTER_CLEAR'); ?></button>
					<?php endif; ?>
				</div>
				<div class="filter-select fltrt">
					<?php if($this->menuParms->get('show_published_filter')) : ?>
					<select name="forms_filter_published" class="inputbox f2c_pubfilter" onchange="this.form.submit()">
					...
					<select name="forms_filter_category_id" class="inputbox f2c_catfilter" onchange="this.form.submit()">
