...
$document->addScriptDeclaration( $script );
?>
<form action="<?php echo JRoute::_( 'index.php?option=com_advancedmodules&layout=edit&id='.(int) $this->item->id ); ?>"
	...
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			...
			<ul class="adminformlist">
				...
				<?php
				if ( $this->item->client_id == 0 && $this->config->show_hideempty ) {
					echo $this->render( $this->assignments, 'hideempty' );
				}
				?>
				...
				<?php
				/*if ( $this->config->show_color ) {
					echo $this->render( $this->assignments, 'color' );
				}*/
				?>
