		...
		switch($ajaxTask)
		{
			case 'start':
				...
				if($tag == 'restorepoint') {
					...
					AEPlatform::getInstance()->configOverrides = $this->getConfigOverridesForSRP($extname, $info);
					...
					AEPlatform::getInstance()->configOverrides['volatile.core.finalization.action_handlers'] = array(
						new AEFinalizationSrpquotas()						
					);
					AEPlatform::getInstance()->configOverrides['volatile.core.finalization.action_queue'] = array(
						'remove_temp_files',
						'update_statistics',
						'update_filesizes',
						'apply_srp_quotas'
