...
<table class="adminlist">
	<thead>
		...
		<tr>
			<td></td>
			<td width="280">
				<?php echo JHTML::_('calendar', $this->lists->fltDateFrom, 'datefrom', 'datefrom', '%Y-%m-%d', array('onchange'=>'document.adminForm.submit();')); ?>
				&ndash;
				<?php echo JHTML::_('calendar', $this->lists->fltDateTo, 'dateto', 'dateto', '%Y-%m-%d', array('onchange'=>'document.adminForm.submit();')); ?>
			</td>
			<td>
				<input type="text" name="ip" id="ip"
					value="<?php echo $this->escape($this->lists->fltIP);?>" size="30"
			...
			<td>
				<?php echo AdmintoolsHelperSelect::reasons($this->lists->fltReason, 'reason', array('onchange'=>'document.adminForm.submit();')) ?>
			</td>
			<td>
				<input type="text" name="url" id="url"
					value="<?php echo $this->escape($this->lists->fltURL);?>" size="30"
					class="text_area" onchange="document.adminForm.submit();" />
				<button onclick="this.form.submit();">
					<?php echo JText::_('Go'); ?>
				</button>
