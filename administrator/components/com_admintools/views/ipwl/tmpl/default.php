...
<form name="adminForm" action="index.php" method="POST">
	...
	<input type="hidden" name="view" id="view" value="ipwl" />
...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th>
				<?php echo JHTML::_('grid.sort', 'ATOOLS_LBL_IPWL_IP', 'ip', $this->lists->order_Dir, $this->lists->order); ?>
			</th>
			<th>
				<?php echo JHTML::_('grid.sort', 'ATOOLS_LBL_IPWL_DESCRIPTION', 'description', $this->lists->order_Dir, $this->lists->order); ?>
			</th>
		</tr>
		<tr>
			<td></td>
	...
	<?php else : ?>
		<tr>
			<td colspan="3" align="center"><?php echo JText::_('ATOOLS_ERR_IPWL_NOITEMS') ?></td>
		</tr>
	<?php endif ?>
	</tbody>
</table>
