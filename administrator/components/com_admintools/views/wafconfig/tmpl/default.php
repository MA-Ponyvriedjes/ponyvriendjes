...
<form name="adminForm" id="adminForm" action="index.php" method="post">
	...
	<fieldset>
		...
		<div class="editform-row">
			<label for="iplookup" title="<?php echo JText::_('ATOOLS_LBL_WAF_IPLOOKUP_DESC') ?>">
				<?php echo JText::_('ATOOLS_LBL_WAF_IPLOOKUP_LABEL'); ?>
			</label>
			<span>
				<?php echo AdmintoolsHelperSelect::httpschemes('iplookupscheme', array(), $this->wafconfig['iplookupscheme']) ?>
